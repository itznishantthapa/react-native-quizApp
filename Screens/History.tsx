...
const History = ({navigation}) => {
    const {getQuizData} = useContext(MyContext);
    ...
    return (
        <SafeAreaView style={styles.background}>
            ...
            <View style={ { flex:1, alignItems: 'center', justifyContent: 'flex-start' }}>
                ...
                <TouchableWithoutFeedback onPress={()=>handleDualByHistory('database')}>
                ...
                <TouchableWithoutFeedback onPress={()=>handleDualByHistory('programming')}>
                <View style={[InPageStyle.historyQuestionBox, { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }]}>
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <TouchableWithoutFeedback onPress={()=>handleDualByHistory('networking')}>
                <View style={[InPageStyle.historyQuestionBox, { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }]}>
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <TouchableWithoutFeedback onPress={()=>handleDualByHistory('cloud computing')}>
                <View style={[InPageStyle.historyQuestionBox, { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }]}>
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
